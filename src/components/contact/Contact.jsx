            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=+212610883364&text=Hello, more information!" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i> </a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <a href="https://www.instagram.com/mouadfikri2/" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i> </a>
                    </div>
                </div>
            </div>
