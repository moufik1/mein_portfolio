  ...
  return (
    <header className="header">
        <nav className="nav container">
            <a href="index.html" className="nav__logo">Mouad Fikri</a>
                ...
                <ul className="nav__list grid">
                    ...
                    <li className="nav__item">
                        <a href="#skills"  onClick={() => setActiveNav ('#skills')} className={activeNav === "#skills" ? 
                         "nav__link active-link" : "nav__link"}>
                            <i className="uil uil-file-alt nav__icon"></i>Fähigkeiten
                        </a>
                    </li>
                    <li className="nav__item">
                        <a href="#document"  onClick={() => setActiveNav ('#document')} className={activeNav === "#document" ? 
                         "nav__link active-link" : "nav__link"}>
                            <i className="uil uil-briefcase-alt nav__icon"></i>Unterlagen
                        </a>
                    </li>
                    <li className="nav__item">
